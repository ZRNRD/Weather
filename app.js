...
const getArrayOfCitiesFromLetters = (letters) => {
    const cities = 
    [
      {
...
document.querySelector(".city-input").addEventListener("keyup", (e) => {
    ...
    if(getArrayOfCitiesFromLetters(e.target.value).length !== 0){
        getArrayOfCitiesFromLetters(e.target.value).forEach((city)=>{
